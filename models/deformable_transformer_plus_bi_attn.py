...
from .fusion_helper_mix_fft import VR_Fuse
...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
        ...
        fusion_layer = VR_Fuse()
        # one layer for early fusion is enough
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, ref_pts=None,
        ...
        memory = self.encoder(
            ...
            referring_dict_features=referring_dict_features
        )
        # early fusion
        memory, referring_dict_features = memory["visual"], memory["referring"]
        ...
        if self.two_stage:
            return hs, init_reference_out, inter_references_out, enc_outputs_class, enc_outputs_coord_unact, referring_dict_features
        return hs, init_reference_out, inter_references_out, None, None, referring_dict_features
...
class DeformableTransformerEncoder(nn.Module):
    ...
    def forward(
            ...
            pos=None, padding_mask=None, referring_dict_features=None
    ):
        # output = src
        output = {"visual": src, "referring": referring_dict_features}
...
class DeformableTransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
                query_pos=None, src_padding_mask=None, lvl_pos_embed_flatten=None):
        # b, n, c = tgt.shape
...
def build_deformable_transformer_bi_attn(args):
