...
def get_args_parser():
    ...
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/audio-guided-kitti.train', type=str,
    ...
    parser.add_argument('--finetune_audio_encoder', action='store_true', default=False)
    return parser
...
def main(args):
    ...
    if args.dataset_file in ['e2e_rmot', 'e2e_rmot_bdd']:
